...
UpNextJobEntity _job({String? customerPhone = '+923001234567'}) =>
    UpNextJobEntity(
      jobId: 1,
...
void main() {
  group('UpNextJobCard', () {
    ...
    group('job present — content', () {
      ...
      testWidgets('shows "Contact Customer" CTA button', (tester) async {
        await tester.pumpWidget(buildCard(job: _job()));
        await tester.pump();
    ...
    group('job absent — empty state', () {
      ...
      testWidgets('does not render "Contact Customer"', (tester) async {
        await tester.pumpWidget(buildCard(job: null));
        await tester.pump();
