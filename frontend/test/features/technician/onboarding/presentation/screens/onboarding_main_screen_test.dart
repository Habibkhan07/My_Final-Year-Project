...
void main() {
  group('OnboardingMainScreen (Orchestrator) Tests', () {
    ...
    testWidgets('should render Next button on Step 0', (WidgetTester tester) async {
    ...
    testWidgets('should render Submit Application button on final step (Step 5)', (WidgetTester tester) async {
