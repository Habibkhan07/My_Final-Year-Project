...
void main() {
  group('BookingTechAvatar', () {
    testWidgets('renders network image when imageUrl is non-null', (tester) async {
      await mockNetworkImagesFor(() async {
        await tester.pumpWidget(
          _wrap(const BookingTechAvatar(
    ...
    testWidgets('renders initials fallback when imageUrl is null', (tester) async {
      await tester.pumpWidget(
        _wrap(const BookingTechAvatar(
          imageUrl: null,
          displayName: 'Ahmed Khan',
    ...
    testWidgets('renders initials fallback when imageUrl is empty string', (tester) async {
      await tester.pumpWidget(
        _wrap(const BookingTechAvatar(
          imageUrl: '   ',
          displayName: 'Ahmed Khan',
    ...
    testWidgets('all-whitespace name → empty initials, no crash', (tester) async {
      await tester.pumpWidget(
        _wrap(const BookingTechAvatar(
          imageUrl: null,
          displayName: '   ',
