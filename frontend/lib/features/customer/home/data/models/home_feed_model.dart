...
class TechnicianFeedModel {
  ...
  factory TechnicianFeedModel.fromJson(Map<String, dynamic> json) =>
      TechnicianFeedModel(
        id: json['id'],
...
class HomeFeedModel {
  ...
  factory HomeFeedModel.fromJson(Map<String, dynamic> json) => HomeFeedModel(
    ...
    promotions: (json['promotions'] as List)
        .map((i) => PromotionModel.fromJson(i))
        .toList(),
    fixedGigs: (json['fixed_gigs'] as List)
        .map((i) => FixedGigModel.fromJson(i))
        .toList(),
    topTechnicians: (json['top_technicians'] as List)
        .map((i) => TechnicianFeedModel.fromJson(i))
        .toList(),
  );
