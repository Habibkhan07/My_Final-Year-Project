...
/// the screen distinguishes (offline / server / unknown). Copy is
/// distinct per variant — generic "Something went wrong" is forbidden
/// per session_4 §14.
class BookingsErrorState extends StatelessWidget {
  const BookingsErrorState._({
    required this.icon,
  ...
  factory BookingsErrorState.offline({required VoidCallback onRetry}) =>
      BookingsErrorState._(
  ...
  factory BookingsErrorState.server({required VoidCallback onRetry}) =>
      BookingsErrorState._(
        icon: Icons.error_outline,
        headline: "Couldn't load your bookings",
        body: 'Something went wrong on our end. Please try again.',
        onRetry: onRetry,
      );

  factory BookingsErrorState.unknown({required VoidCallback onRetry}) =>
      BookingsErrorState._(
        icon: Icons.error_outline,
        headline: "Couldn't load your bookings",
