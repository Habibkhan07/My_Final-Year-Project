...
//
// `bookingType` and `payoutContext` are nullable on this model — §2.5 spec:
// pre-rollout `EventLog` rows replayed via `/api/events/sync/` predate these
// fields. The mapper applies the `null bookingType → laborGig` default; this
// model stays faithful to the wire so deserializer tests can assert "fresh"
// vs "replayed" payloads round-trip correctly.
