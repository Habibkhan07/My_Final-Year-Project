...
/// happens in the mapper.
 String get payout;@JsonKey(name: 'payout_context') String? get payoutContext;@JsonKey(name: 'expires_in_seconds') int get expiresInSeconds;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,jobId,serviceName,bookingType,scheduledStartIso,payout,payoutContext,expiresInSeconds);

@override
String toString() {
  return 'JobNewRequestPayloadModel(jobId: $jobId, serviceName: $serviceName, bookingType: $bookingType, scheduledStartIso: $scheduledStartIso, payout: $payout, payoutContext: $payoutContext, expiresInSeconds: $expiresInSeconds)';
}
...
/// Create a copy of JobNewRequestPayloadModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? jobId = null,Object? serviceName = null,Object? bookingType = freezed,Object? scheduledStartIso = null,Object? payout = null,Object? payoutContext = freezed,Object? expiresInSeconds = null,}) {
...
switch (_that) {
case _JobNewRequestPayloadModel() when $default != null:
return $default(_that.jobId,_that.serviceName,_that.bookingType,_that.scheduledStartIso,_that.payout,_that.payoutContext,_that.expiresInSeconds);case _:
  return orElse();
...
/// Create a copy of JobNewRequestPayloadModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? jobId = null,Object? serviceName = null,Object? bookingType = freezed,Object? scheduledStartIso = null,Object? payout = null,Object? payoutContext = freezed,Object? expiresInSeconds = null,}) {
