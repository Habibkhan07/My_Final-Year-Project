...
/// Shimmer placeholder for [ScheduledJobCard]. Dimensions mirror the real
/// card so there's no layout flash on data arrival.
///
/// Render 4 of these stacked with the same `s3` gap the list uses.
class ScheduledJobCardSkeleton extends StatelessWidget {
  const ScheduledJobCardSkeleton({super.key});
    ...
    return Shimmer.fromColors(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(color: BookingsPalette.brandPrimaryTint12),
